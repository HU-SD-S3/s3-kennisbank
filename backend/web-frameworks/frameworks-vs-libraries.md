...
er vanuit dat al je code in een named package zit, en dat alle
...
We zien in hier een aantal onderdelen. \@Component zorgt
...
sectie in de *pom.xml* (Pom staat voor Project Object Model). In de
...
dependency), en tot slot een version. Soms wordt dit opgeschreven in XML zoals hieronder,
soms achter elkaar met dubbele punten ertussen: *org.junit.jupiter:junit-jupiter:5.10.2*.
...
Verder zie je dat ons project zelf ook een volledige set
...
verplicht is in Maven om dit op te geven.
